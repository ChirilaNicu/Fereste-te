...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_objects("FERESTE-TE", largetext)
        TextRect.center = (400, 100)
        gamedisplays.blit(TextSurf, TextRect)
        # dimensiuni butoane interfata
        button("START", 300, 320, 200, 50, green, bright_green, "play")
        button("INSTRUCTION", 300, 370, 200, 50, blue, bright_blue, "intro")
        button("QUIT", 300, 420, 200, 50, red, bright_red, "quit")
...
# meniu instriuctiuni, explicatii
...
# pauza dupa inceperea jocului, meniu
